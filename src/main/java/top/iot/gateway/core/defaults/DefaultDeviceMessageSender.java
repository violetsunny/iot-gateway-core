...
public class DefaultDeviceMessageSender implements DeviceMessageSender {
    ...
    private static final long DEFAULT_TIMEOUT = TimeUnit.SECONDS.toMillis(Integer.getInteger("iot.gateway.device.message.default-timeout", 10));
    ...
    private Mono<String> refreshAndGetConnectionServerId() {
        return Mono
                .defer(() -> operator
                        .refreshConfig(Collections.singleton(DeviceConfigKey.connectionServerId.getKey()))
