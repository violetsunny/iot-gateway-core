...
import top.iot.gateway.core.exception.ProductNotActivatedException;
...
import top.iot.gateway.core.things.ThingRpcSupport;
import top.iot.gateway.core.things.ThingRpcSupportChain;
...
public class DefaultDeviceOperator implements DeviceOperator, StorageConfigurable {
    ...
    public DefaultDeviceOperator(String id,
        ...
        this.protocolSupportMono = this
                .getSelfConfig(DeviceConfigKey.protocol)
        ...
        this.metadataMono = this
                ...
                .flatMap(i -> {
                    ...
                    //加载真实的物模型
                    return Mono
                            .zip(getSelfConfig(DeviceConfigKey.metadata),
                                 protocolSupportMono)
                            .flatMap(tp2 -> tp2
                                    .getT2()
                                    .getMetadataCodec()
    ...
    private final static List<String> stateCacheKeys = Arrays
            .asList(stateKey.getKey(),
                    DeviceConfigKey.parentGatewayId.getKey(),
                    DeviceConfigKey.selfManageState.getKey(),
...
//                            }
    ...
    public Mono<Boolean> offline() {
        return this
                .setConfigs(
                        ...
                        DeviceConfigKey.connectionServerId.value(""),
                        DeviceConfigKey.sessionId.value(""),
    ...
    public Mono<Void> resetMetadata() {
        ...
        return removeConfigs(DeviceConfigKey.metadata, lastMetadataTimeKey)
