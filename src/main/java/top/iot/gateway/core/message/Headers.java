...
import top.iot.gateway.core.utils.DeviceMessageTracer;
...
public interface Headers {
    ...
    /**
     * 异步消息,当发往设备的消息标记了为异步时,设备网关服务发送消息到设备后将立即回复{@link ErrorCode#REQUEST_HANDLING}到发送端
     *
