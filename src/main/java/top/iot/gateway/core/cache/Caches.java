...
public class Caches {
    ...
    private static boolean caffeinePresent() {
        if (Boolean.getBoolean("iot.gateway.cache.caffeine.disabled")) {
            return false;
        }
        try {
    ...
    private static boolean jctoolPresent() {
        if (Boolean.getBoolean("iot.gateway.cache.jctool.disabled")) {
            return false;
        }
        try {
    ...
    private static boolean guavaPresent() {
        return !Boolean.getBoolean("iot.gateway.cache.guava.disabled");
    }
