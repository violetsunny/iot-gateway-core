...
declare interface DecodeContext {
     ...
     * 获取原始透传消息
     */
    message(): top.iot.gateway.core.message.DirectMessage;
...
declare interface EncodeContext {
     ...
     * 获取平台下发的原始消息
     */
    message(): top.iot.gateway.core.message.ReadPropertyMessage |  top.iot.gateway.core.message.WritePropertyMessage |  top.iot.gateway.core.message.FunctionInvokeMessage;
